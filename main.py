...
DIVISIONS = ["Dhaka", "Rajshahi", "Chattogram", "Khulna", "Sylhet", "Barishal", "Rangpur", "Mymensingh",
             ...
             "Pabna", "Noakhali", "Feni", "Brahmanbaria", "Kushtia", "Satkhira", "Jhenaidah", "Magura",
             "Natore", "Chapai Nawabganj", "Lalmonirhat", "Nilphamari", "Thakurgaon", "Panchagarh",
             "Joypurhat", "Naogaon", "Sirajganj", "Faridpur", "Madaripur", "Shariatpur", "Gopalganj",
             "Manikganj", "Munshiganj", "Kishoreganj", "Netrokona", "Sherpur", "Jamalpur", "Habiganj",
             "Moulvibazar", "Sunamganj", "Lakshmipur", "Chandpur", "Narsingdi", "Rajbari", "Meherpur",
             "Chuadanga", "Bagerhat", "Pirojpur", "Jhalokathi", "Barguna", "Patuakhali", "Bhola",
             "Kurigram", "Gaibandha", "Rangamati", "Khagrachari", "Bandarban"]
...
{{
    "doctors": [
        {{"name": "Dr. Name", "specialty": "{doctor_specialty}", "hospital": "Hospital in {location}", "address": "Address", "fee": "fee BDT", "contact": "phone", "available": "time", "experience": "years", "rating": "4.5", "qualification": "MBBS"}}
    ]
}}"""
